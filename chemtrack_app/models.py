...
class Record_descriptor(models.Model):
    ...
    feedback_level = models.IntegerField(default=0)
    final_level = models.IntegerField(default=0)
    draft_statement = models.TextField(default="", blank=True)
    feedback_statement = models.TextField(default="", blank=True)
    final_statement = models.TextField(default="", blank=True)